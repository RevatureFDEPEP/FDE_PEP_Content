...
---
*Prerequisites: day-11-server-authoritative-state, day-12-idempotency-for-retried-mutations, day-14-form-state-collection-with-react-hook-form. Forward references: day-14-optimistic-updates-vs-server-confirmation, day-14-submit-and-lock-ux-patterns, day-14-graceful-network-failure-handling, day-14-component-unit-testing-patterns-vitest.*
