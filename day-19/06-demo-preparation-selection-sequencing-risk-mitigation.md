...
---
*Prerequisites: [01-vertical-slice-integration-in-a-local-compose-environment.md](../day-15/01-vertical-slice-integration-in-a-local-compose-environment.md), [05-state-coverage-ui-empty-loading-error.md](05-state-coverage-ui-empty-loading-error.md).*
