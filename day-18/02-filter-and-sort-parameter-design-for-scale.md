...
---
*Prerequisites: [04-filtering-pagination-and-sorting-patterns-in-fastapi.md](../day-16/04-filtering-pagination-and-sorting-patterns-in-fastapi.md), [01-aggregate-query-patterns-group-by-having-window-functions.md](01-aggregate-query-patterns-group-by-having-window-functions.md), [02-alembic-for-relational-schema-evolution.md](../day-10/02-alembic-for-relational-schema-evolution.md).*
