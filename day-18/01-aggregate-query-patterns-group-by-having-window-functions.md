...
---
*Prerequisites: [02-sqlalchemy-queries-joins-aggregates-subqueries.md](../day-16/02-sqlalchemy-queries-joins-aggregates-subqueries.md), [03-per-entity-aggregation-query-patterns.md](../day-16/03-per-entity-aggregation-query-patterns.md), [02-alembic-for-relational-schema-evolution.md](../day-10/02-alembic-for-relational-schema-evolution.md).*
