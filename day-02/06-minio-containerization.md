...
---
*Prerequisites: [03-local-orchestration-with-docker-compose.md](03-local-orchestration-with-docker-compose.md), [05-postgresql-containerization.md](05-postgresql-containerization.md) (named volume pattern)*
