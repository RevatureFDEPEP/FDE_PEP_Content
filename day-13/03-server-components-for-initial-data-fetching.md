...
---
*Prerequisites: [02-server-vs-client-component-boundary.md](../day-09/02-server-vs-client-component-boundary.md), [07-opaque-token-generation-and-session-identifiers.md](../day-11/07-opaque-token-generation-and-session-identifiers.md), [02-dynamic-routing-with-app-router-parameters.md](02-dynamic-routing-with-app-router-parameters.md). Forward references: [04-client-components-for-stateful-interactivity.md](04-client-components-for-stateful-interactivity.md), [06-authentication-context-propagation-through-the-component-tree.md](06-authentication-context-propagation-through-the-component-tree.md).*
