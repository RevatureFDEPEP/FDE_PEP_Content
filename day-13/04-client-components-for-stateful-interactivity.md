...
---
*Prerequisites: [02-server-vs-client-component-boundary.md](../day-09/02-server-vs-client-component-boundary.md), [03-server-components-for-initial-data-fetching.md](03-server-components-for-initial-data-fetching.md). Forward references: [09-multi-step-ui-navigation-without-state-loss.md](09-multi-step-ui-navigation-without-state-loss.md), [08-polymorphic-component-rendering-for-variant-data-types.md](08-polymorphic-component-rendering-for-variant-data-types.md), [01-react-state-management-patterns-usestate-vs-usereducer.md](../day-14/01-react-state-management-patterns-usestate-vs-usereducer.md).*
