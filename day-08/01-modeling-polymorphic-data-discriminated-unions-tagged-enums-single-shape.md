...
---
*Prerequisites: Day 1 Topic 6 (brownfield decision frameworks — orientation depth), Day 2 (FastAPI services in the substrate, MongoDB containerization). Followed by [02-schema-validation-patterns.md](02-schema-validation-patterns.md) (the rule layer on top of whichever shape you chose).*
