...
---
*Prerequisites: `day-3-github-actions-structure-workflows-jobs-steps-runners.md`, `day-3-yaml-syntax-pitfalls.md`, `day-1-polyglot-development-environment-git-pnpm-python-docker.md`.*
