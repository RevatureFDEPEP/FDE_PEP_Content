...
---
*Prerequisites: [day-1-codebase-navigation-conventions.md](day-1-codebase-navigation-conventions.md), [day-1-microservices-architecture-and-service-boundaries.md](day-1-microservices-architecture-and-service-boundaries.md). Sets up Day 2 (Docker Compose stack-up) and Days 3–4 (CI debugging).*
