...
---
*Prerequisites: [day-1-fde-role-and-pep-positioning-in-the-three-phase-programme.md](day-1-fde-role-and-pep-positioning-in-the-three-phase-programme.md). Connects forward to Day 2 (Docker Compose stack-up brings these services up together) and Week 4 (you build the reporting-and-analytics service).*
