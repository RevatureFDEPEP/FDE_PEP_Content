...
---
*Prerequisites: [04-client-components-for-stateful-interactivity.md](../day-13/04-client-components-for-stateful-interactivity.md), [04-client-side-temporal-state-timers-and-autosave.md](../day-14/04-client-side-temporal-state-timers-and-autosave.md), [06-submit-and-lock-ux-patterns.md](../day-14/06-submit-and-lock-ux-patterns.md), [04-end-to-end-smoke-testing-patterns.md](04-end-to-end-smoke-testing-patterns.md).*
