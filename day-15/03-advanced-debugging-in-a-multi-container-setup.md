...
---
*Prerequisites: [09-container-debugging-logs-exec-troubleshooting.md](../day-02/09-container-debugging-logs-exec-troubleshooting.md), [03-reverse-proxy-fundamentals-nginx-traefik.md](../day-06/03-reverse-proxy-fundamentals-nginx-traefik.md), [05-database-transactions-and-pessimistic-locking.md](../day-12/05-database-transactions-and-pessimistic-locking.md), [02-distributed-log-analysis-across-services.md](02-distributed-log-analysis-across-services.md).*
