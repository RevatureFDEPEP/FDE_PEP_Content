...
---
*Prerequisites: [04-unique-constraints-and-concurrent-write-race-conditions.md](04-unique-constraints-and-concurrent-write-race-conditions.md), [08-server-authoritative-state.md](../day-11/08-server-authoritative-state.md), [03-async-await-patterns-in-python-web-frameworks.md](../day-11/03-async-await-patterns-in-python-web-frameworks.md). Forward references: [06-state-finalization-and-immutability-patterns.md](06-state-finalization-and-immutability-patterns.md), [07-edge-case-handling-for-distributed-clients.md](07-edge-case-handling-for-distributed-clients.md).*
