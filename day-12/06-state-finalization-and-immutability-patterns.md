...
---
*Prerequisites: [05-database-transactions-and-pessimistic-locking.md](05-database-transactions-and-pessimistic-locking.md), [03-idempotency-for-retried-mutations.md](03-idempotency-for-retried-mutations.md), [08-server-authoritative-state.md](../day-11/08-server-authoritative-state.md). Forward references: day-16 results aggregation reads scored sessions, [07-edge-case-handling-for-distributed-clients.md](07-edge-case-handling-for-distributed-clients.md).*
