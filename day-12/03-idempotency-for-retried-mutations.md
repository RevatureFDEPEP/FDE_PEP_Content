...
---
*Prerequisites: [07-opaque-token-generation-and-session-identifiers.md](../day-11/07-opaque-token-generation-and-session-identifiers.md), [09-error-handling-and-http-status-code-discipline.md](../day-11/09-error-handling-and-http-status-code-discipline.md). Forward references: [04-unique-constraints-and-concurrent-write-race-conditions.md](04-unique-constraints-and-concurrent-write-race-conditions.md), [05-database-transactions-and-pessimistic-locking.md](05-database-transactions-and-pessimistic-locking.md), day-14 frontend retry handling.*
