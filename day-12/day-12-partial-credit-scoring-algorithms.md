...
---
*Prerequisites: day-12-deterministic-scoring-algorithms-exact-match. Forward references: day-12-ai-assisted-test-authoring (parametrized tests over all three algorithms), day-20 architecture defense.*
