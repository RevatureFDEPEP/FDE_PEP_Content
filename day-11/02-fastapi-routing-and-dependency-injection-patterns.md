...
The substrate convention (see [01-fastapi-service-scaffolding-conventions.md](../day-10/01-fastapi-service-scaffolding-conventions.md)) puts one `APIRouter` per resource in `app/routers/`. For Week 3 we'll add:
...
---
*Prerequisites: [01-fastapi-service-scaffolding-conventions.md](../day-10/01-fastapi-service-scaffolding-conventions.md), day-8 backend topics.*
