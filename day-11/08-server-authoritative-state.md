...
---
*Prerequisites: [07-opaque-token-generation-and-session-identifiers.md](07-opaque-token-generation-and-session-identifiers.md), [06-pydantic-request-response-modeling.md](06-pydantic-request-response-modeling.md). Forward references: day-12 attempt locking, day-14 visible timer.*
