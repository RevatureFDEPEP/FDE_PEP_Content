...
---
*Prerequisites: [day-1-microservices-architecture-and-service-boundaries.md](day-1-microservices-architecture-and-service-boundaries.md). Sets up [day-1-codebase-navigation-conventions.md](day-1-codebase-navigation-conventions.md) (the literal map of the substrate) and [day-1-tech-stack-comprehension-identifying-whats-in-use-legacy-or-at-risk.md](day-1-tech-stack-comprehension-identifying-whats-in-use-legacy-or-at-risk.md).*
